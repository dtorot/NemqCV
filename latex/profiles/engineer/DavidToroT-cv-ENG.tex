...
\begin{itemize}
	...
	\item EF English Skills test \href{https://raw.githubusercontent.com/dtorot/NemqCV/master/latexdocs/efTest2021.pdf}{\faIcon{external-link-alt}}
\end{itemize}
...
\begin{itemize}
	...
	\item RHCSA Rapid Track (RH199), \textit{Red Hat Training and Certification} (September 2022) \href{https://raw.githubusercontent.com/Open-SAI/NemqCV/master/latex/docs/Certificate of Attendance (RH199-8.0).pdf}{\faIcon{external-link-alt}}
	\item Red Hat System Administration I (RH124), \textit{Red Hat Training and Certification} (October 2022) \href{https://raw.githubusercontent.com/Open-SAI/NemqCV/master/latex/docs/Certificate of Attendance_RH124-9_0.pdf}{\faIcon{external-link-alt}}	
	\item Red Hat System Administration II (RH134), \textit{Red Hat Training and Certification} (October 2022) \href{https://raw.githubusercontent.com/Open-SAI/NemqCV/master/latex/docs/Certificate of Attendance (RH134-9.0).pdf}{\faIcon{external-link-alt}}
	\item Red Hat Satellite 6 Administration (RH403), \textit{Red Hat Training and Certification} (January 2023) \href{https://raw.githubusercontent.com/Open-SAI/NemqCV/master/latex/docs/Certificate of Attendance (RH403-6.6).pdf}{\faIcon{external-link-alt}}
	\item Introduction to OpenShift Applications (DO101), \textit{Red Hat Training and Certification} (January 2023) \href{https://raw.githubusercontent.com/Open-SAI/NemqCV/master/latex/docs/Certificate of Attendance (DO101-4.6).pdf}{\faIcon{external-link-alt}}
	\item Developing Advanced Automation with Red Hat Ansible Automation Platform (DO374), \textit{Red Hat Training and Certification} (March 2023) \href{https://raw.githubusercontent.com/Open-SAI/NemqCV/master/latex/docs/Certificate of Attendance (DO374).pdf}{\faIcon{external-link-alt}}
	\item \href{https://raw.githubusercontent.com/Open-SAI/NemqCV/master/latex/docs/Red_Hat_Certified_System_Administrator_RHCSA_Badge20230403_28_153keud.pdf}{Red Hat Certified System Administrator (RHCSA) \faIcon{external-link-alt}}, \textit{Red Hat Training and Certification} (March 2023) 
	\item Red Hat Services Management and Automation (RH358), \textit{Red Hat Training and Certification} (April 2023) \href{https://raw.githubusercontent.com/Open-SAI/NemqCV/master/latex/docs/Certificate of Attendance (RH358).pdf}{\faIcon{external-link-alt}}
	\item \href{https://raw.githubusercontent.com/Open-SAI/NemqCV/master/latex/docs/Red_Hat_Certified_Specialist_in_Deployment_and_Systems_Management.pdf}{Red Hat Certified Specialist in Deployment and Systems Management \faIcon{external-link-alt}}, \textit{Red Hat Training and Certification} (July 2023) 
\end{itemize} 
